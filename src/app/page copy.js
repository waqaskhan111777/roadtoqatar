  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-28 overflow-hidden" style={{ backgroundColor: '#C8FF00' }}>
        ...
        <div className="absolute bottom-0 right-0 w-1/5 h-1/3">
          <Image
            src="/images/decorative-bg-2.png"
            alt=""
            fill
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-2/3 md:pl-12">
              ...
              <button className="bg-red-700 text-white px-6 py-2 rounded-md font-semibold hover:bg-red-800 transition-colors">
                Get Started
              </button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3 md:pr-12 mb-8 md:mb-0">
              ...
              <button className="bg-white text-red-900 px-6 py-2 rounded-md font-semibold hover:bg-gray-100 transition-colors">
                Discover More
              </button>
            </div>
            <div className="md:w-1/3">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex space-x-8 mb-4 md:mb-0">
              <a href="#" className="hover:text-red-200">Cookie Policy</a>
              <a href="#" className="hover:text-red-200">Terms of Use</a>
              <a href="#" className="hover:text-red-200">Ticketing Terms & Condition</a>
              <a href="#" className="hover:text-red-200">Privacy Policy</a>
            </div>
            <div className="flex space-x-4">
              <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center">
                <span className="text-red-900 text-sm">f</span>
              </div>
              <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center">
                <span className="text-red-900 text-sm">t</span>
              </div>
              <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center">
                <span className="text-red-900 text-sm">in</span>
              </div>
            </div>
          </div>
        </div>
